...
{
	const int exp = 0;
	intersects[0] = 3.2, intersects[1] = 2, intersects[2] = 1.5, intersects[3] = 2.8, intersects[4] = 1.5, intersects[5] = 5, intersects[6] = 0, intersects[7] = 1, intersects[8] = 2.5;
...
{
	const int exp = 1;
	intersects[0] = 3.2, intersects[1] = 15, intersects[2] = 1.5, intersects[3] = 2.8, intersects[4] = 1.5, intersects[5] = 5, intersects[6] = 0, intersects[7] = 1, intersects[8] = 0.5;
	int res = cross(intersects);
	ASSERT_EQUAL(exp, res);
}
...
{
	triangle_points[0] = 2, triangle_points[1] = 1, triangle_points[2] = 4, triangle_points[3] = 3, triangle_points[4] = 5, triangle_points[5] = 9;
